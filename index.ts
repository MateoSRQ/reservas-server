    ...
    let config = [
      {
        ...
        hoursEnd: ["09:00:00", "10:00:00", "11:00:00", "15:00:00", "16:00:00"],
        door: "VMZP05X",
      },
      /*
      {
         ...
         */
      {
        place: "Costa Verde",
        name:
          "Cancha 04 - Handball Playa / Fútbol Playa / Rugby Playa / Flag Football / Fly Disc",
        dates: [mar, dom],
        quota: 8,
        low: 2,
        hi: 8,
      ...
      },
      {
        place: "Costa Verde",
        name:
          " Cancha 05 - Handball Playa / Fútbol Playa / Rugby Playa / Flag Football / Fly Disc",
        dates: [mar, dom],
        quota: 8,
        low: 2,
        hi: 8,
      ...
      },
      {
        place: "Costa Verde",
        name:
          " Cancha 01 - Vóley Playa/ Tenis Playa/ Bádminton Playa / Fútvoley",
        dates: [mar, dom],
        quota: 8,
        low: 2,
        hi: 8,
      ...
      },
      {
        place: "Costa Verde",
        name:
          " Cancha 02 - Vóley Playa/ Tenis Playa/ Bádminton Playa / Fútvoley",
        dates: [mar, dom],
        quota: 8,
        low: 2,
        hi: 8,
      ...
      },
      {
        place: "Costa Verde",
        name:
          " Cancha 03 - Vóley Playa/ Tenis Playa/ Bádminton Playa / Fútvoley",
        dates: [mar, dom],
        quota: 8,
        low: 2,
        hi: 8,
      ...
      },
      {
        place: "Costa Verde",
        name:
          "Losa 04 - Danzas/ Bailes/ Actividades de relajación y meditación/ Artes Marciales/ Ejercicios Funcionales y Aeróbicos ",
        dates: [mar, dom],
        quota: 87,
        low: 1,
        hi: 87,
      ...
      },
      {
        place: "Costa Verde",
        name:
          "Losa 10 - Danzas/ Bailes/ Actividades de relajación y meditación/ Artes Marciales/ Ejercicios Funcionales y Aeróbicos ",
        dates: [mar, dom],
        quota: 23,
        low: 1,
        hi: 23,
      ...
      },
      {
        place: "Costa Verde",
        name:
          "Losa 04 - Jockey En Patines/ Bike Polo (Ambos Solo Práctica)/Patines",
        dates: [mar, dom],
        quota: 31,
        low: 1,
        hi: 31,
        group: "f",
        hoursBegin: ["09:00:00", "10:00:00", "11:00:00"],
        hoursEnd: ["10:00:00", "11:00:00", "12:00:00"],
        door: "CVZP04X",
      },
      {
        place: "Costa Verde",
